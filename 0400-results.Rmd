...
BUL-04 was intermediate in composition but showed high within-site variability, particularly in Chironomidae (6–37% across replicates) and Ephemeroptera (30–63%), suggesting fine-scale habitat heterogeneity at that site.
...
The Hilsenhoff Biotic Index (HBI) provided the clearest gradient among sites: BUL-01 averaged 4.14, indicating "possible slight organic pollution"; BUL-04 averaged 3.51; and BUL-05 averaged 2.58, indicating "excellent" water quality with no apparent organic pollution (Table \@ref(tab:tab-hbi-interp-cap)). This downstream-to-upstream improvement is consistent with the nutrient gradient documented by historical water quality monitoring and the community composition patterns described above.
