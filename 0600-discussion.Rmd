...
1. **Submit 2025 data to CABIN.** Uploading our results under either the "BC-Neexdzi Kwa" study or the existing Wet'suwet'en ESI study would contribute to the regional reference condition model and enable BEAST (BEnthic Assessment of SedimenT) assessments. Adding BUL-01 data to the MOR37 record extends the monitoring time series at that location. Pending confirmation of data submission protocols with ECCC, the revised Skeena RCA model [@bennett2011revisedpredictive] could then be used to formally evaluate whether observed communities deviate from reference condition predictions.
...
3. **Collect water samples alongside benthic samples.** Measuring nutrient concentrations (phosphorus, nitrogen species) and basic water quality parameters at each site on the same day as invertebrate sampling would directly link the biological patterns we've documented to the chemical conditions driving them — strengthening the evidence base for nutrient management decisions in the watershed.

4. **Expand the monitoring network.** The current three-site design covers the mainstem nutrient gradient between Houston and McQuarrie Creek but leaves gaps in our understanding of the broader watershed. Priority expansions include: (a) mainstem reaches upstream of BUL-05, above the McQuarrie confluence, to test whether excellent conditions persist beyond the influence of this cold-water tributary; (b) Buck Creek, including sites near the Equity Silver Mine, to assess aquatic health in the watershed's largest tributary; and (c) key tributaries with documented chinook use and restoration potential — such as Richfield Creek, Maxan Creek, and Byman Creek — where benthic data would provide baseline context for restoration planning and help prioritize stewardship activities.
